####################################################
# Implementation of Glove Algorithm(MIT)
# Github repository clone, with some custom expansion
####################################################
...
class glove_vector:
    def __init__(self, embeddings, mapping, dims):
    ...
    def get_emb(self, word):
        try:
            return self.embeddings[self.mapping[word]]
        except KeyError:
...
class GloVeModel():
    ...
    def train(self, num_epochs, log_dir=None, summary_batch_interval=1000,
        ...
        with tf.Session(graph=self.__graph) as session:
            ...
            # ____________________________edited content return custom object from tensorflow
            return glove_vector(self.__embeddings, self.__word_to_id, self.embedding_size)
